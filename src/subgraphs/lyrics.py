...
class LyricsInputSchema(TypedDict):
    ...
    # Lyrics workflow context (for continuing conversations)
    ...
    # Pending track info (set during identification, used for purchase)
...
class LyricsOutputSchema(TypedDict):
    ...
    # Pending track info for purchase handoff
    pending_track_id: Optional[int]
    pending_track_name: Optional[str]
    pending_track_price: Optional[float]
...
def handle_response_node(state: LyricsInternalState) -> dict:
